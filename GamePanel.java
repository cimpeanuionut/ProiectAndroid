    ...
    public void update()

      {
        if (player.getPlaying()) {
            ...
            //add smoke puffs timer
            long elapsed = (System.nanoTime() - smokeStarTime) / 1000000;
    ...
    public void updateTopBorder() {
        ...
        for (int i = 0; i < topborder.size(); i++) {
            ...
            if (topborder.get(i).getX() < -20) {
                topborder.remove(i);
                //remove element of arraylist replace it by adding a new once
